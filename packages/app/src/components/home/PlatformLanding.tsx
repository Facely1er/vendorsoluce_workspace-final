 ...
 * Journey: Website (learn) → Platform (sign in / get started / dashboard preview) → Full demo or dashboard.
 */
...
const PlatformLanding: React.FC = () => {
  ...
  return (
    <section className="relative flex flex-col px-4 sm:px-6 lg:px-8 overflow-hidden py-12 sm:py-16 lg:pb-20">
      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-col gap-12 lg:gap-14">
        <div className="grid w-full gap-10 lg:min-h-[52vh] lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:items-center lg:gap-12">
