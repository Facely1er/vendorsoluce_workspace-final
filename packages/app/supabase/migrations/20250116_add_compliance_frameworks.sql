/*
  ...
  This migration extends the assessment framework system to support:
  - SOC2 Type II
  - ISO 27001
  - FedRAMP
  - FISMA
  ...
  ## Changes:
  - Extends framework_type CHECK constraint to include new frameworks
  - Inserts framework definitions for SOC2, ISO 27001, FedRAMP, FISMA
  - Maintains backward compatibility with existing frameworks
*/
